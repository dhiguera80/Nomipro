...
urlpatterns = [
    ...
    url(r'^Nomipro/', include('apps.administrar_nomina.urls')),
    ...
    url(r'^reset/password_reset/$',PasswordResetView.as_view(template_name='registration/password_reset_form.html', 
       ...
       name='password_reset'),
    url(r'^reset/passwordResetDone',PasswordResetDoneView.as_view(template_name='registration/password_reset_done.html'), 
